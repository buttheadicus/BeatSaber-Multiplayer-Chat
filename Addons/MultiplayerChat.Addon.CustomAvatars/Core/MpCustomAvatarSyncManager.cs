...
public sealed class MpCustomAvatarSyncManager : MonoBehaviour, IInitializable
{
    ...
    private const float MaintenanceIntervalSeconds = 0.75f;
    ...
    {
        Instance?.SendLocalMetadata(targetUserId: null, includeDescriptor: true, includeScale: true);
    }
    ...
    public static void SendLocalMetadataToUser(string targetUserId)
    {
        ...
        Instance?.SendLocalMetadata(targetUserId, includeDescriptor: true, includeScale: true);
    }
    ...
    {
        Instance?.SendLocalMetadata(targetUserId: null, includeDescriptor: false, includeScale: true);
        Instance?.SendLocalMetadata(targetUserId: null, includeDescriptor: true, includeScale: true);
    }
