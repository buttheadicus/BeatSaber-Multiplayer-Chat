...
$sm = $asm.GetType('CustomAvatar.Configuration.SettingsManager')
$sm.GetMembers($flags) | ForEach-Object { $_.ToString() }
$gsh = $asm.GetType('CustomAvatar.UI.GeneralSettingsHost')
$gsh.GetMethod('OnPlayerEyeHeightChanged', $flags).ToString()
