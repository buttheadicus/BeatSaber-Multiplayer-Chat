...
- **Floor button** – "TEXT CHAT" button on the lobby floor (next to shoes/avatar when available, or in the title bar).
...
3. Place `MultiplayerChat.dll` in your Beat Saber `Plugins` folder.
